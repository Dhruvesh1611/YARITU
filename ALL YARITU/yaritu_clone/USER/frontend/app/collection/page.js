              ...
              <div className={styles['dropdown-menu']}>
                ...
                <div className={styles['dropdown-column']}>
                  ...
                  <ul>
                    ...
                    <li><a href="#" onClick={(e) => { e.preventDefault(); handleTypeClick('CHILDREN', 'SAREE', 'GIRLS'); }}>ANARKALI SUITS</a></li>
                  </ul>
                </div>
              </div>
            </div>
