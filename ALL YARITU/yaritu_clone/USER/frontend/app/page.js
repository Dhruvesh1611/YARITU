      ...
      <div className="page-content-wrapper">
        ...
        <section id="section-trending" className="section-container">
          ...
          <div ref={trendingContainerRef} className="trending-images-container">
            ...
            <Image src="/images/reel2.png" alt="Trending 1" className="trending-img" style={{ left: '66px', top: '145px', width: '204px', height: '363px', zIndex: 2 }} width={204} height={363} />
            <Image src="/images/reel3.png" alt="Trending 2" className="trending-img" style={{ left: '279px', top: '106px', width: '224px', height: '441px', zIndex: 3 }} width={214} height={441} />
            <Image src="/images/reel4.png" alt="Trending 3" className="trending-img" style={{ left: '512px', top: '67px', width: '245px', height: '527px', zIndex: 4 }} width={215} height={527} />
            <Image src="/images/reel5.png" alt="Trending 4" className="trending-img" style={{ left: '766px', top: '106px', width: '224px', height: '441px', zIndex: 3 }} width={214} height={441} />
            <Image src="/images/reel2.png" alt="Trending 5" className="trending-img" style={{ left: '999px', top: '145px', width: '204px', height: '363px', zIndex: 2 }} width={204} height={363} />
          </div>
        </section>
