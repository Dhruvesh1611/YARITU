          ...
          <div className={styles.infoWrapper}>
            ...
            <div className={styles.infoCardsContainer}>
              <div className={styles.infoCard}>
                <Image src="/images/location.png" alt="Location icon" className={styles.infoIcon} width={24} height={24} />
              ...
              <div className={styles.infoCard}>
                <Image src="/images/call.png" alt="Call icon" className={styles.infoIcon} width={24} height={24} />
                <div className={styles.infoText}>
                  <h3>Call Us</h3>
                  <p>+91 98765 43210</p>
                  <p>+91 98765 43211</p>
              ...
              <div className={styles.infoCard}>
                <Image src="/images/email.png" alt="Email icon" className={styles.infoIcon} width={24} height={24} />
                <div className={styles.infoText}>
                  <h3>Email Us</h3>
                  <p>info@yaritu.com</p>
              ...
              <div className={styles.infoCard}>
                <Image src="/images/time.png" alt="Time icon" className={styles.infoIcon} width={24} height={24} />
                <div className={styles.infoText}>
